/*! For license information please see bundle.3c25b3.js.LICENSE.txt */
(() => {
  var e = {
      583: (e, t, n) => {
        "use strict";
        ...
        function ti(e) {
          var t = $a.current;
          sa($a), (e.type._context._currentValue = t);
        }
        function ni(e, t) {
          for (; null !== e; ) {
            var n = e.alternate;
        ...
        function Os() {
          if (null === $l) return !1;
          var e = $l;
          if ((($l = null), 0 != (48 & Tl))) throw Error(o(331));
          var t = Tl;
          Tl |= 32;
          var n = Jl;
          Jl = [];
        ...
        (Wl = function (e, t, n) {
          ...
          (Je = function (e) {
            13 === e.tag && (cs(e, 4, ss()), $s(e, 4));
          }),
          (et = function (e) {
            13 === e.tag && (cs(e, 67108864, ss()), $s(e, 67108864));
          }),
          (tt = function (e) {
            if (13 === e.tag) {
              var t = ss(),
      ...
      932: (e, t, n) => {
        ...
        o.push([
          e.id,
          ".DeDm1uP7ZnTtwn14rPEk {\n  cursor: pointer;\n  user-select: none;\n  font-size: 16px;\n  font-weight: bold;\n  text-align: center;\n  border-radius: 22px;\n  color: rgb(196, 196, 196);\n  padding: 5px 10px 5px 10px;\n  border: 1px solid rgba(196, 196, 196, 0.2);\n}\n",
          "",
        ]),
          (o.locals = { generateButton: "DeDm1uP7ZnTtwn14rPEk" });
        const l = o;
      },
      645: (e) => {
        "use strict";
      ...
      535: (e, t, n) => {
          ...
          cache(e) {
            ...
            if (r && a) {
              ...
              var d = new Q({
                ...
                h = new Q({ pixelRatio: i, width: 0, height: 0 }),
                f = new $({ pixelRatio: c, width: r, height: a }),
                p = d.getContext(),
                g = f.getContext();
              return (
                (f.isCache = !0),
        ...
        class Ne extends ge {
          constructor(e) {
            super(e),
              (this.canvas = new Q()),
              (this.hitCanvas = new $({ pixelRatio: 1 })),
          ...
          _sceneFunc(e) {
            ...
            if ((e.beginPath(), t)) {
              let a = 0,
                ...
                l = 0;
              "number" == typeof t
                ? (a = i = o = l = Math.min(t, n / 2, r / 2))
                : ((a = Math.min(t[0] || 0, n / 2, r / 2)),
                  (i = Math.min(t[1] || 0, n / 2, r / 2)),
                  (l = Math.min(t[2] || 0, n / 2, r / 2)),
                  (o = Math.min(t[3] || 0, n / 2, r / 2))),
                e.moveTo(a, 0),
                e.lineTo(n - i, 0),
                e.arc(n - i, i, i, (3 * Math.PI) / 2, 0, !1),
                e.lineTo(n, r - l),
                e.arc(n - l, r - l, l, 0, Math.PI / 2, !1),
                e.lineTo(o, r),
                e.arc(o, r - o, o, Math.PI / 2, Math.PI, !1),
                e.lineTo(0, a),
                e.arc(a, a, a, Math.PI, (3 * Math.PI) / 2, !1);
            } else e.rect(0, 0, n, r);
            e.closePath(), e.fillStrokeShape(this);
          }
        }
        (Fe.prototype.className = "Rect"),
          C(Fe),
          j.addGetterSetter(
            Fe,
            "cornerRadius",
                    ...
                    n ||
                      ...
                      A.warn(
                        N(e) +
                          ' is a not valid value for "' +
                          t +
                          '" attribute. The value should be a number or Array<number>(4)'
                      ),
                    e
                  );
                };
        ...
        const ot = {
          ...
          st = (e) => {
            const t = lt(e);
            return "pointer" === t
              ? S.pointerEventsEnabled && ot.pointer
              : "touch" === t
              ? ot.touch
              : "mouse" === t
              ? ot.mouse
        ...
        class dt extends ge {
          ...
          destroy() {
            ...
            var t = ct.indexOf(this);
            return t > -1 && ct.splice(t, 1), this;
          }
          getPointerPosition() {
            const e =
          ...
          _contextmenu(e) {
            ...
            t && t.isListening()
              ? t._fireAndBubble(Je, { evt: e })
              : this._fire(Je, { evt: e, target: this, currentTarget: this });
          }
          _wheel(e) {
            this.setPointersPositions(e);
            var t = this.getIntersection(this.getPointerPosition());
            t && t.isListening()
              ? t._fireAndBubble(at, { evt: e })
              : this._fire(at, { evt: e, target: this, currentTarget: this });
          }
          _pointercancel(e) {
            this.setPointersPositions(e);
            const t =
            ...
            t && t._fireAndBubble(Xe, be(e)), ke(e.pointerId);
          }
        ...
        (dt.prototype.nodeType = "Stage"),
          C(dt),
          j.addGetterSetter(dt, "container");
        var ht = (function () {
          function e(e, t, n) {
            var r = this;
            (this.setupKonvaStage = function (e, t, n) {
              var r = new dt({ container: e, width: t, height: n }),
                a = new Ne();
              return r.add(a), r;
            }),
              (this.clear = function () {
        ...
        const mt = function (e, t) {
            ...
            (this.canvas = e),
              ...
              (this.interpretStepwise = function (e) {
                return (
                  (t = n),
                  (r = void 0),
                  (i = function () {
              ...
              (this.execute = function (e) {
                switch (e) {
                  case "G":
                  case "F":
                    if (!gt(n.plant.stemDrawChance)) break;
                  case "T":
                    n.drawLine(
                      n.plant.stemColor,
                      n.currentState.stemLength,
                      n.currentState.stemWidth,
                      "round"
                    );
                    break;
                  case "+":
                    n.rotate(
                      pt(
                        n.plant.angle - n.plant.angleDerivation,
                        n.plant.angle + n.plant.angleDerivation
                      )
                    );
                    break;
                  ...
                  case "[":
                    (n.currentState.stemWidth *=
                      n.plant.stemWidthReductionRatio),
                      n.currentState.stemWidth < 1 &&
                        (n.currentState.stemWidth = 1),
                      gt(n.plant.stemLengthReductionChance) &&
                        (n.currentState.stemLength *=
                          n.plant.stemLengthReductionRatio),
                      n.currentState.stemLength < 1 &&
                        (n.currentState.stemLength = 1),
                      n.pushState();
                    break;
                  case "]":
              ...
              (this.getLeafColor = function () {
                var e,
                  t = n.plant.leafColors;
                return t[((e = t.length), Math.floor(Math.random() * e))];
              }),
              (this.drawLine = function (e, t, r, a) {
                void 0 === r && (r = 1), void 0 === a && (a = "butt");
                var i = n.currentState.x,
                  o = n.currentState.y,
                  l = n.currentState.angle,
                  s = i - t * Math.sin((Math.PI * l) / 180),
                  u = o - t * Math.cos((Math.PI * l) / 180);
                n.canvas.drawLine(i, o, s, u, e, r, a),
                  (n.currentState.x = s),
                  (n.currentState.y = u);
              }),
              (this.rotate = function (e) {
                n.currentState.angle += e;
              }),
              (this.pushState = function () {
                n.stateStack.push(vt({}, n.currentState));
              }),
              (this.popState = function () {
                var e = n.stateStack.pop();
                e && (n.currentState = e);
              });
          },
          yt = (function () {
        ...
        var wt = n(932),
          _t = {};
        (_t.styleTagTransform = m()),
          (_t.setAttributes = f()),
          (_t.insert = d().bind(null, "head")),
          (_t.domAPI = u()),
          (_t.insertStyleElement = g()),
          l()(wt.Z, _t);
        const kt = wt.Z && wt.Z.locals ? wt.Z.locals : void 0,
          St = function (e) {
            var t = e.onClick;
            return r.createElement(
              "div",
              { className: kt.generateButton, onClick: t },
              "Generate New"
            );
          };
        var Ct = function (e, t) {
            e.clear();
            var n = xt(t.axiom, t.rules, t.iteration);
            new mt(e, t).interpret(n);
          },
          xt = function (e, t, n) {
            for (var r = new yt(), a = e, i = 0; i < n; i++)
              a = r.applyRules(a, t);
            return a;
          };
        const Et = (0, i.w)(function () {
          var e,
            t = bt.SAKURA,
            n = "canvas";
          return (
            (0, r.useEffect)(function () {
              (e = new ft(n, 600, 500)), Ct(e, t);
            }, []),
            r.createElement(
              "div",
              ...
              r.createElement("div", { className: w.canvas, id: n })
            )
          );
        });
        var Pt = n(28),
          Tt = {};
        (Tt.styleTagTransform = m()),
          (Tt.setAttributes = f()),
          (Tt.insert = d().bind(null, "head")),
          (Tt.domAPI = u()),
          (Tt.insertStyleElement = g()),
          l()(Pt.Z, Tt),
          Pt.Z && Pt.Z.locals && Pt.Z.locals;
        var Lt = document.getElementById("app");
        a.render(r.createElement(Et, null), Lt);
      },
    },
    t = {};
  function n(r) {
